...
public class MenuTransaksiController implements Initializable{
    ...
    void hapusData(ActionEvent event) throws IOException {
        Penjualan pjl=new Penjualan(Integer.parseInt(id.getText()));
        PenjualanModel model=new PenjualanModel();
        model.deletePenjualan(pjl);
    ...
    void openForm(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("MenuKasir.fxml"));
        Parent root = loader.load();
